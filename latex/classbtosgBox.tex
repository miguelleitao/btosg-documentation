...
{\footnotesize\ttfamily btosg\+Box\+::btosg\+Box (\begin{DoxyParamCaption}\item[{osg\+::\+Vec3}]{dim = {\ttfamily osg\+:\+:Vec3(1.,1.,1.)},  }\item[{double}]{m = {\ttfamily 1.} }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
